...
\f\r"'\`<>=]|("|')|))|$)`,"g"),At=/'/g,St=/"/g,kt=/^(?:script|style|textarea|title)$/i,dt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),p=dt(1),ht=dt(2),ne=dt(3),S=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Et=new WeakMap,x=A.createTreeWalker(A,129);function Ot(r,t){if(!lt(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return bt!==void 0?bt.createHTML(t):t}var Wt=(r,t)=>{let e=r.length-1,s=[],i,o=t===2?"<svg>":t===3?"<math>":"",n=L;for(let a=0;a<e;a++){let c=r[a],h,u,d=-1,g=0;for(;g<c.length&&(n.lastIndex=g,u=n.exec(c),u!==null);)g=n.lastIndex,n===L?u[1]==="!--"?n=wt:u[1]!==void 0?n=xt:u[2]!==void 0?(kt.test(u[2])&&(i=RegExp("</"+u[2],"g")),n=w):u[3]!==void 0&&(n=w):n===w?u[0]===">"?(n=i??L,d=-1):u[1]===void 0?d=-2:(d=n.lastIndex-u[2].length,h=u[1],n=u[3]===void 0?w:u[3]==='"'?St:At):n===St||n===At?n=w:n===wt||n===xt?n=L:(n=w,i=void 0);let f=n===w&&r[a+1].startsWith("/>")?" ":"";o+=n===L?c+Ft:d>=0?(s.push(h),c.slice(0,d)+Ct+c.slice(d)+$+f):c+$+(d===-2?a:f)}return[Ot(r,o+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},D=class r{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,n=0,a=t.length-1,c=this.parts,[h,u]=Wt(t,e);if(this.el=r.createElement(h,s),x.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=x.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let d of i.getAttributeNames())if(d.endsWith(Ct)){let g=u[n++],f=i.getAttribute(d).split($),_=/([.?@])?(.*)/.exec(g);c.push({type:1,index:o,name:_[2],strings:f,ctor:_[1]==="."?rt:_[1]==="?"?ot:_[1]==="@"?nt:O}),i.removeAttribute(d)}else d.startsWith($)&&(c.push({type:6,index:o}),i.removeAttribute(d));if(kt.test(i.tagName)){let d=i.textContent.split($),g=d.length-1;if(g>0){i.textContent=K?K.emptyScript:"";for(let f=0;f<g;f++)i.append(d[f],U()),x.nextNode(),c.push({type:2,index:++o});i.append(d[g],U())}}}else if(i.nodeType===8)if(i.data===Rt)c.push({type:2,index:o});else{let d=-1;for(;(d=i.data.indexOf($,d+1))!==-1;)c.push({type:7,index:o}),d+=$.length-1}o++}}static createElement(t,e){let s=A.createElement("template");return s.innerHTML=t,s}};function k(r,t,e=r,s){if(t===S)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,o=j(t)?void 0:t._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),o===void 0?i=void 0:(i=new o(r),i._$AT(r,e,s)),s!==void 0?(e._$Co??=[])[s]=i:e._$Cl=i),i!==void 0&&(t=k(r,i._$AS(r,t.values),i,s)),t}var it=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??A).importNode(e,!0);x.currentNode=i;let o=x.nextNode(),n=0,a=0,c=s[0];for(;c!==void 0;){if(n===c.index){let h;c.type===2?h=new I(o,o.nextSibling,this,t):c.type===1?h=new c.ctor(o,c.name,c.strings,this,t):c.type===6&&(h=new at(o,this,t)),this._$AV.push(h),c=s[++a]}n!==c?.index&&(o=x.nextNode(),n++)}return x.currentNode=A,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},I=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),j(t)?t===l||t==null||t===""?(this._$AH!==l&&this._$AR(),this._$AH=l):t!==this._$AH&&t!==S&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Vt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==l&&j(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=D.createElement(Ot(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let o=new it(i,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=Et.get(t.strings);return e===void 0&&Et.set(t.strings,e=new D(t)),e}k(t){lt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let o of t)i===e.length?e.push(s=new r(this.O(U()),this.O(U()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=$t(t).nextSibling;$t(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},O=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=l,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=l}_$AI(t,e=this,s,i){let o=this.strings,n=!1;if(o===void 0)t=k(this,t,e,0),n=!j(t)||t!==this._$AH&&t!==S,n&&(this._$AH=t);else{let a=t,c,h;for(t=o[0],c=0;c<o.length-1;c++)h=k(this,a[s+c],e,c),h===S&&(h=this._$AH[c]),n||=!j(h)||h!==this._$AH[c],h===l?t=l:t!==l&&(t+=(h??"")+o[c+1]),this._$AH[c]=h}n&&!i&&this.j(t)}j(t){t===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},rt=class extends O{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===l?void 0:t}},ot=class extends O{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==l)}},nt=class extends O{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??l)===S)return;let s=this._$AH,i=t===l&&s!==l||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==l&&(s===l||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},at=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}};var Kt=ct.litHtmlPolyfillSupport;Kt?.(D,I),(ct.litHtmlVersions??=[]).push("3.3.3");var Nt=(r,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let o=e?.renderBefore??null;s._$litPart$=i=new I(t.insertBefore(U(),o),o,void 0,e??{})}return i._$AI(r),i};var pt=globalThis,m=class extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Nt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return S}};m._$litElement$=!0,m.finalized=!0,pt.litElementHydrateSupport?.({LitElement:m});var Jt=pt.litElementPolyfillSupport;Jt?.({LitElement:m});(pt.litElementVersions??=[]).push("4.2.2");var J=r=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(r,t)}):customElements.define(r,t)};var Gt={attribute:!0,type:String,converter:z,reflect:!1,hasChanged:W},Yt=(r=Gt,t,e)=>{let{kind:s,metadata:i}=e,o=globalThis.litPropertyMetadata.get(i);if(o===void 0&&globalThis.litPropertyMetadata.set(i,o=new Map),s==="setter"&&((r=Object.create(r)).wrapped=!0),o.set(e.name,r),s==="accessor"){let{name:n}=e;return{set(a){let c=t.get.call(this);t.set.call(this,a),this.requestUpdate(n,c,r,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,r,a),a}}}if(s==="setter"){let{name:n}=e;return function(a){let c=this[n];t.call(this,a),this.requestUpdate(n,c,r,!0,a)}}throw Error("Unsupported decorator location: "+s)};function N(r){return(t,e)=>typeof e=="object"?Yt(r,t,e):((s,i,o)=>{let n=i.hasOwnProperty(o);return i.constructor.createProperty(o,s),n?Object.getOwnPropertyDescriptor(i,o):void 0})(r,t,e)}function G(r){return N({...r,state:!0,attribute:!1})}var E="goe_steve";function ut(r){let t=new Map;for(let e of Object.values(r.entities))if(!(e.platform!==E||!e.device_id)&&!t.has(e.device_id)){let s=r.devices[e.device_id];t.set(e.device_id,s?.name_by_user||s?.name||e.device_id)}return[...t.entries()].map(([e,s])=>({id:e,name:s}))}function Tt(r,t){let e={tag_energy:[]};if(!t){let o=ut(r);o.length===1&&(t=o[0].id)}if(e.deviceId=t,!t)return e;let s=Object.values(r.entities).filter(o=>o.platform===E&&o.device_id===t),i=o=>{let n=s.find(c=>c.translation_key===o);return n?n.entity_id:s.find(c=>{let h=c.entity_id.split(".")[1]??"";return h===o||h.endsWith(`_${o}`)})?.entity_id};return e.status=i("status"),e.power_flow=i("power_flow"),e.surplus=i("surplus_for_car"),e.target_current=i("target_current"),e.controlling=i("controlling"),e.charging_mode=i("charging_mode"),e.battery_policy=i("battery_policy"),e.smart_control=i("smart_control"),e.auto_phase=i("auto_phase"),e.active_transaction=i("active_transaction"),e.last_session_energy=i("last_session_energy"),e.selected_tag=i("selected_tag"),e.tag_energy=s.filter(o=>o.translation_key==="tag_energy"||o.entity_id.split(".")[1]?.includes("_tag_energy_")).map(o=>o.entity_id).sort(),e}var gt={"card.no_device":"No {name} device found. Set one up first, then add this card.","card.default_title":"Smart Charging","flow.solar":"Solar","flow.grid":"Grid","flow.export":"Export","flow.battery":"Battery","flow.home":"Home","flow.car":"Car","flow.no_car":"No car","control.mode":"Mode","control.battery":"Battery","control.smart_control":"Smart control","control.tag":"Tag","action.authorize":"Authorize","action.start":"Start","action.stop":"Stop","session.none":"No active session","session.charging":"Charging: {state}","session.last":"Last session: {energy}","session.blocked":"blocked","session.tag":"tag","editor.device":"Smart Charging device (optional \u2014 auto-detected)","editor.title":"Title (optional)","editor.show_flow":"Show energy flow","editor.show_controls":"Show controls","editor.show_sessions":"Show sessions & RFID"},Zt={"card.no_device":"Kein {name}-Ger\xE4t gefunden. Richte zuerst eines ein und f\xFCge dann diese Karte hinzu.","card.default_title":"Intelligentes Laden","flow.solar":"Solar","flow.grid":"Netz","flow.export":"Einspeisung","flow.battery":"Batterie","flow.home":"Haus","flow.car":"Auto","flow.no_car":"Kein Auto","control.mode":"Modus","control.battery":"Batterie","control.smart_control":"Intelligente Steuerung","control.tag":"Tag","action.authorize":"Freigeben","action.start":"Starten","action.stop":"Stoppen","session.none":"Kein aktiver Ladevorgang","session.charging":"L\xE4dt: {state}","session.last":"Letzter Ladevorgang: {energy}","session.blocked":"gesperrt","session.tag":"Tag","editor.device":"Smart-Charging-Ger\xE4t (optional \u2014 automatisch erkannt)","editor.title":"Titel (optional)","editor.show_flow":"Energiefluss anzeigen","editor.show_controls":"Steuerung anzeigen","editor.show_sessions":"Ladevorg\xE4nge & RFID anzeigen"},Qt={en:gt,de:Zt};function Xt(r){let t=(r?.locale?.language||r?.language||"en").toLowerCase().split("-")[0];return Qt[t]??gt}function b(r,t,e={}){let i=Xt(r)[t]??gt[t]??t;for(let[o,n]of Object.entries(e))i=i.replace(`{${o}}`,n);return i}var C=class extends m{constructor(){super(...arguments);this._schema=[{name:"device",selector:{device:{integration:E}}},{name:"title",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_flow",selector:{boolean:{}}},{name:"show_controls",selector:{boolean:{}}},{name:"show_sessions",selector:{boolean:{}}}]}];this._label=e=>{switch(e.name){case"device":return b(this.hass,"editor.device");case"title":return b(this.hass,"editor.title");case"show_flow":return b(this.hass,"editor.show_flow");case"show_controls":return b(this.hass,"editor.show_controls");case"show_sessions":return b(this.hass,"editor.show_sessions");default:return e.name}}}setConfig(e){this._config=e}render(){return!this.hass||!this._config?l:p`<ha-form
  ...
  `,y([N({attribute:!1})],C.prototype,"hass",2),y([G()],C.prototype,"_config",2),C=y([J("goe-steve-card-editor")],C);var te="go-e + SteVe Smart Charging",q=r=>{if(r==null||Number.isNaN(r))return"\u2014";let t=Math.abs(r);return t>=1e3?`${(r/1e3).toFixed(t>=1e4?0:1)} kW`:`${Math.round(r)} W`},R=class extends m{static getConfigElement(){return document.createElement("goe-steve-card-editor")}static getStubConfig(t){return{type:"custom:goe-steve-card",device:ut(t)[0]?.id}}setConfig(t){this._config={show_flow:!0,show_controls:!0,show_sessions:!0,...t}}getCardSize(){return 8}get _entities(){return this.hass?Tt(this.hass,this._config?.device):null}_t(t,e={}){return b(this.hass,t,e)}render(){if(!this.hass||!this._config)return l;let t=this._entities;if(!t||!t.deviceId)return p`<ha-card>
    ...
    </ha-card>`}_renderNoDevice(){let[t,e]=this._t("card.no_device").split("{name}");return p`${t}<b>${te}</b>${e??""}`}_renderHeader(t,e){let s=this._stateObj(t.status),i=s?.state&&s.state!=="unknown"?s.state:"\u2014",o=this._isOn(t.controlling),n=this._displayState(t.charging_mode),a=this._displayState(t.battery_policy);return p`<div class="header">
      <div class="title-row">
    ...
    </div>`}_renderFlow(t){let e=this._stateObj(t.power_flow),s=e?.attributes??{},i=Number(s.pv_w??NaN),o=Number(s.grid_w??NaN),n=s.battery_w===null||s.battery_w===void 0?null:Number(s.battery_w),a=Number(s.car_w??(e?e.state:NaN)),c=Number(s.house_w??NaN),h=s.battery_soc,u=s.car_connected,d=50,g=(_,T,Z,Q,X,Ht="")=>ht`
      ...
      <svg viewBox="0 0 320 320" preserveAspectRatio="xMidYMid meet">
        ...
        ${f("M76,160 L134,160",Number.isNaN(o)?!1:Math.abs(o)>d,o<0,Math.abs(o))}
        ${n!==null?f("M244,160 L186,160",Math.abs(n)>d,n>0,Math.abs(n)):l}
        ${f("M160,186 L160,244",a>d,!1,a)}
        ...
        ${n!==null?g(280,160,"mdi:home-battery",this._t("flow.battery"),q(Math.abs(n)),h!=null?` ${Math.round(Number(h))}%`:""):l}
      ...
      ${i?p`<div class="control">
            ...
            <ha-switch
              ...
              @change=${o=>this._toggle(t.smart_control,o)}
            ></ha-switch>
          </div>`:l}
    ...
    >
    ...
    </select>`}_renderSessions(t){let e=this._stateObj(t.active_transaction),s=this._stateObj(t.last_session_energy),i=this._stateObj(t.selected_tag),o=t.tag_energy.map(a=>this._stateObj(a)).filter(a=>!!a);if(!e&&!s&&!i&&o.length===0)return l;let n=!!e&&!["idle","unknown","unavailable",""].includes(e.state);return p`<div class="sessions">
      ...
      ${o.length?p`<div class="tags">
            ${o.map(a=>p`<div class="tag">
